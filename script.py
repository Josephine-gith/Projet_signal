...
if __name__ == "__main__":
    ...
    wavfile.write(
        os.path.join("results", "speech_resampled.wav"), sampling_rate, speech
    )
    ...
    wavfile.write(
        os.path.join("results", "block_reconstruction.wav"), sampling_rate, rec
    )
    ...
    wavfile.write(
        os.path.join("results", "decoded_speech.wav"), sampling_rate, decoded_speech
    )
    ...
    wavfile.write(
        os.path.join("results", "decoded_speech_noise.wav"),
        sampling_rate,
        decoded_speech,
    )
    ...
    wavfile.write(
        os.path.join("results", "decoded_speech_pitch.wav"),
        sampling_rate,
        decoded_speech,
    )
